...
module Tattoo
  describe Gun do
    ...
    describe "multiple markings" do
      before do
        @tags = [Ink.new(:tags, TAG_REGEXP), Ink.new(:users, USER_REGEXP, :identifier => "@")]
      end
    ...
    describe "tattoo" do
      ...
      it "should substitute :tag with tag" do
        tags = Ink.new(:tags, TAG_REGEXP, :host => "example.com", :url => "/tags/:tag")
        gun = Gun.new("#foo", [tags])
